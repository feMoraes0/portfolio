...
import {SvgVariants} from './animation';
...
const BackgroundDetail = ({ width, shapeNumber = 0 }: BackgroundDetailProps) => {
  ...
  const getD = () => {
    if(shapeNumber > ds.length - 1 || shapeNumber < 0) {
      return ds[0];
    }
    return ds[shapeNumber];
  };
