    ...
    <div id='project'>
      <div className='carrousel-texts'>
        <AnimatePresence exitBeforeEnter>
          <motion.div key={projectId} variants={carrouselTextVariants} initial='initial' animate='animate' exit='exit'>
            <h1>Project Name</h1>
            ...
            <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg">
              <motion.path variants={logoGitVariants} d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22" />
            </svg>
          </motion.div>
        </AnimatePresence>
      </div>
      <div className='carrousel-cards'>
        <AnimatePresence exitBeforeEnter>
          <motion.div key={projectId} variants={cardImageVariants} initial='initial' animate='animate' exit='exit' className='card-image'>
            <img src="https://via.placeholder.com/1920x1080" alt="project"/>
          </motion.div>
        </AnimatePresence>
        <motion.div variants={controlsVariants} initial='initial' animate='animate' className='controls'>
          <button onClick={() => setProjectId(projectId + 1)}><svg stroke="currentColor" fill="none" strokeWidth="1" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg"><polyline points="15 18 9 12 15 6"></polyline></svg></button>
