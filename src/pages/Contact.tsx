  ...
  return (
    ...
    >
      ...
      <div className="social">
        <a
          href="https://www.linkedin.com/in/fernando-moraes-48a26916a/"
          target='_blank'
        ...
        >
          <svg stroke="currentColor" fill="none" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg">
            ...
            <motion.path
              variants={svgVariants}
              d="M 2 9 H 6 V 21 H 2 L 2 9"
            />
            <motion.path
              variants={svgVariants}
              d="M2,4a2,2 0 1,0 4,0a2,2 0 1,0 -4,0"
            />
          </svg>
        </a>
        <a
          href="https://github.com/feMoraes0"
          target='_blank'
          rel="noopener noreferrer"
        >
          <svg stroke="currentColor" fill="none" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg">
        ...
        <a
          href="https://www.facebook.com/fernando.moraes.796/"
          target='_blank'
          rel="noopener noreferrer"
        >
          <svg stroke="currentColor" fill="none" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg">
        ...
        <a
          href="mailto:fernandomoraes.lopes@gmail.com"
          target='_blank'
          rel="noopener noreferrer"
        >
          <svg stroke="currentColor" fill="none" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg">
