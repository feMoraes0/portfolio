  ...
  return (
    ...
    >
      ...
      <ContentInfoSide>
        ...
        <Subtitle variants={cardTextVariants}>
          I'm really grateful for everything that these companies taught,
          and teach, me and all experiences which I had working there.
        </Subtitle>
